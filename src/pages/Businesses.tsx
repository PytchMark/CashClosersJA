    ...
    <div className="pt-32">
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <FadeIn className="text-center mb-24">
          <h1 className="text-6xl md:text-8xl mb-8">Elite Sales <br /><span className="gold-text italic">That Just Works.</span></h1>
        ...
        <div className="mb-32">
          <FadeIn className="text-center mb-16">
            <h2 className="text-5xl mb-4">How We Work</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <FadeIn direction="right" className="p-12 rounded-3xl border border-gold/20 bg-gold/5">
              <h3 className="text-3xl mb-6">Commission Only</h3>
            ...
            <FadeIn direction="left" className="p-12 rounded-3xl border border-white/10 bg-white/[0.02]">
              <h3 className="text-3xl mb-6">Monthly Management</h3>
        ...
        <FadeIn className="p-16 rounded-[3rem] border border-white/5 bg-white/[0.01] text-center">
          ...
          <h2 className="text-4xl mb-6 italic">Our Performance Guarantee</h2>
